...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        shakeAnimation.fromValue = NSValue(cgPoint: CGPoint(x: setButton.center.x - 10, y: setButton.center.y))
        shakeAnimation.toValue = NSValue(cgPoint: CGPoint(x: setButton.center.x + 10, y: setButton.center.y))
    ...
    @objc func buttonTapped() {
        setButton.layer.add(shakeAnimation, forKey: "shake")
    }
            ...
            DispatchQueue.global().async {
                if i == 1 {
                    ...
                    DispatchQueue.main.async {
                        ...
                        self.eatMealTime.layer.add(self.rotationAnimation, forKey: "rotation")
                    }
                }
                else if i == 3 {
                    ...
                    DispatchQueue.main.async {
                        ...
                        self.goToSchoolTime.layer.add(self.blinkAnimation, forKey: "blink")
                    }
                }
                semaphore.signal()
            }
